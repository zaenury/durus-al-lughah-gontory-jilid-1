...
public class Bab4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button1next = (Button) findViewById(R.id.button4kalimat);
        button1next.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                Intent i = new Intent(getApplicationContext(), Kalimat4.class);
                startActivity(i);
            }
        });
    }
    ...
    private void play(){
        mp=MediaPlayer.create(this, R.raw.madrosatun);
        try{
            mp.prepare();
    ...
    private void play2(){
        mp2=MediaPlayer.create(this, R.raw.faslun);
        try{
            mp2.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play3(){
        mp3=MediaPlayer.create(this, R.raw.sallatun);
        try{
            mp3.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play4(){
        mp4=MediaPlayer.create(this, R.raw.jidaarunhaaitun);
        try{
            mp4.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play5(){
        mp5=MediaPlayer.create(this, R.raw.sakfun);
        try{
            mp5.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play6(){
        mp6=MediaPlayer.create(this, R.raw.ardun);
        try{
            mp6.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play7(){
        mp7=MediaPlayer.create(this, R.raw.majallatun);
        try{
            mp7.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play8(){
        mp8=MediaPlayer.create(this, R.raw.masjidun);
        try{
            mp8.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play9(){
        mp9=MediaPlayer.create(this, R.raw.finaaun);
        try{
            mp9.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play10(){
        mp10=MediaPlayer.create(this, R.raw.mimsahatun);
        try{
            mp10.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play11(){
        mp11=MediaPlayer.create(this, R.raw.takwiimun);
        try{
            mp11.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play12(){
        mp12=MediaPlayer.create(this, R.raw.saahatun);
        try{
            mp12.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
