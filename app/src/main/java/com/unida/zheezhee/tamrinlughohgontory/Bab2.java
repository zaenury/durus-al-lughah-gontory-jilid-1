...
public class Bab2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button1next = (Button) findViewById(R.id.button2kalimat);
        button1next.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                Intent i = new Intent(getApplicationContext(), Kalimat2.class);
                startActivity(i);
            }
        });
    }
    ...
    private void play(){
        mp=MediaPlayer.create(this, R.raw.sabbuurotun);
        try{
            mp.prepare();
    ...
    private void play2(){
        mp2=MediaPlayer.create(this, R.raw.tollaasatun);
        try{
            mp2.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play3(){
        mp3=MediaPlayer.create(this, R.raw.mistorotun);
        try{
            mp3.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play4(){
        mp4=MediaPlayer.create(this, R.raw.minassyatun);
        try{
            mp4.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play5(){
        mp5=MediaPlayer.create(this, R.raw.kurroosatun);
        try{
            mp5.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play6(){
        mp6=MediaPlayer.create(this, R.raw.mimhaatun);
        try{
            mp6.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play7(){
        mp7=MediaPlayer.create(this, R.raw.naafidhatun);
        try{
            mp7.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play8(){
        mp8=MediaPlayer.create(this, R.raw.miknasatun);
        try{
            mp8.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
