...
public class Bab5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button1next = (Button) findViewById(R.id.button5kalimat);
        button1next.setOnClickListener(new View.OnClickListener() {
            public void onClick(View arg0) {
                Intent i = new Intent(getApplicationContext(), Kalimat5.class);
                startActivity(i);
            }
        });
    }
    ...
    private void play(){
        mp=MediaPlayer.create(this, R.raw.ustaadzun);
        try{
            mp.prepare();
    ...
    private void play2(){
        mp2=MediaPlayer.create(this, R.raw.bikrun);
        try{
            mp2.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play3(){
        mp3=MediaPlayer.create(this, R.raw.tilmiidzun);
        try{
            mp3.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play4(){
        mp4=MediaPlayer.create(this, R.raw.diiwaanun);
        try{
            mp4.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play5(){
        mp5=MediaPlayer.create(this, R.raw.ruznaamatun);
        try{
            mp5.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play6(){
        mp6=MediaPlayer.create(this, R.raw.sariirun);
        try{
            mp6.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play7(){
        mp7=MediaPlayer.create(this, R.raw.sunduukun);
        try{
            mp7.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play8(){
        mp8=MediaPlayer.create(this, R.raw.miqoddatun);
        try{
            mp8.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play9(){
        mp9=MediaPlayer.create(this, R.raw.minbarun);
        try{
            mp9.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play10(){
        mp10=MediaPlayer.create(this, R.raw.mindhodatun);
        try{
            mp10.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
    ...
    private void play11(){
        mp11=MediaPlayer.create(this, R.raw.wisaadatun);
        try{
            mp11.prepare();
        }catch(IllegalStateException e){
            e.printStackTrace();
